...
async def test_device_stats_query_handler_empty():
    ...
    # Assert
    assert result == {"total": 0, "connected": 0, "disconnected": 0}
...
async def test_device_stats_query_handler_all_connected():
    ...
    # Assert
    assert result == {"total": 3, "connected": 3, "disconnected": 0}
...
async def test_device_stats_query_handler_all_disconnected():
    ...
    # Assert
    assert result == {"total": 4, "connected": 0, "disconnected": 4}
