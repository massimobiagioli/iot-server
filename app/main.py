...
from app.routes.auth import logout_router
from app.routes.index import router as index_router
from app.middlewares import SetCurrentUserMiddleware


server = FastAPI()

server.add_middleware(SetCurrentUserMiddleware)
...
server.include_router(logout_router, prefix="/auth")
